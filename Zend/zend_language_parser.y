...
reserved_non_modifiers:
	...
	| T_CLASS_C | T_TRAIT_C | T_FUNC_C | T_METHOD_C | T_LINE | T_FILE | T_DIR | T_NS_C | T_FN | T_MATCH | T_ENUM | T_STRUCT
	| T_PROPERTY_C
;
...
struct_declaration_statement:
		...
		T_STRING extends_from backup_doc_comment '{' class_statement_list '}'
			{ $$ = zend_ast_create_decl(ZEND_AST_CLASS, ZEND_ACC_STRUCT|ZEND_ACC_FINAL, $<num>2, $5, zend_ast_get_str($3), $4, NULL, $7, NULL, NULL); }
;
